...
/*
    Cette table stocke les informations concernants 
    les versements d'un étudiant


  */

CREATE TABLE T_HISTORIQUE_RUB_INS(
    HIS_INS_CODE VARCHAR(50) NOT NULL,
    HIS_DATE_CREATE DATE NOT NULL,
    HIS_RUB_CODE VARCHAR(50) NOT NULL,
    HIS_RUB_LIB VARCHAR(255) NOT NULL,
    HIS_MONTPREVU DOUBLE NOT NULL,
    HIS_RUB_ORDRE INT NOT NULL,
    HIS_FRAIS_UNIQUE BIT NOT NULL 
)
