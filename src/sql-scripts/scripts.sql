...
CREATE TABLE T_FONCTIONNALITE(
    FNC_CODE INTEGER PRIMARY KEY IDENTITY,
    FNC_LIB VARCHAR(255) NULL, 
    FNC_DESCRIPTION VARCHAR(255) NOT NULL
)
...
CREATE TABLE T_JWT(
    ...
    EXPIRE BIGINT,
    UTILISATEUR_ID INT,
    CONSTRAINT FK_JWT (UTILISATEUR_ID) REFERENCES T_UTILISATEUR (UTI_CODE)
)


CREATE TABLE T_PERMISSION(
    PER_ID INTEGER PRIMARY KEY IDENTITY,
    ROL_ID INTEGER NOT NULL, 
    FNC_CODE INTEGER NOT NULL,
    CONSTRAINT FK_PERMISSION_ROL (ROL_ID) REFERENCES T_ROLE (ROL_ID),
    CONSTRAINT FK_PERMISSION_FNC (FNC_CODE) REFERENCES T_FONCTIONNALITE (FNC_CODE)
)

CREATE TABLE T_UTILISATEUR(
    UTI_CODE INTEGER PRIMARY KEY IDENTITY,
    UTI_NOM VARCHAR(255),
    UTI_PASSWORD VARCHAR(255),
    UTI_EMAIL VARCHAR(255),
    UTI_EMAIL VARCHAR(255),
    UTI_USERNAME VARCHAR(255),
    UTI_ACTIF BIGINT,
