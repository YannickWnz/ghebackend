 ...
 *  @jjmadiabola
 *   @YannickWnz
 annee + mois + autoIncrement format 4 
 */
    INS_CODE INT IDENTITY PRIMARY KEY,
    INS_DATE VARCHAR(50) NOT NULL,
    INS_NIVEAU_VALIDATION INT NOT NULL,
...
CREATE TABLE T_RUBRIQUE{
    RUB_CODE INT IDENTITY PRIMARY KEY,
    RUB_LIB VARCHAR(255) NOT NULL,
    RUB_MONTANT DOUBLE NOT NULL,
    RUB_CREER_PAR VARCHAR(255) NOT NULL,
    RUB_VERSION INT NOT NULL
}